...
const I18N_DICTIONARY = {
  en: {
    ...
    "index.legend_special": "Special Eligibility & Credit Assessment",
    "index.label_pwd": "Are you a Person with Disability (Divyang)? *",
    "index.opt_yes": "Yes",
    "index.opt_no": "No",
    // Credit Assessment — Repayment Track Record
    "index.label_repayment": "Repayment History of Existing / Past Loans & Credit Cards *",
    "index.helper_repayment": "Prior home, auto, or personal loans do not disqualify you as long as repayments are regular.",
    "index.opt_repayment_select": "Select repayment history…",
    "index.opt_no_prior": "No prior loans / First-time borrower",
    "index.opt_active_ontime": "Active loans/cards, all EMIs paid on time",
    "index.opt_minor_delays": "Past minor delays (1-30 days), now regularized",
    "index.opt_npa": "Account currently marked NPA / 90+ days overdue / Written off",
    // Credit Assessment — Optional CIBIL Score
    "index.label_cibil": "Estimated CIBIL / Credit Score",
    "index.tag_optional": "(Optional)",
    "index.cibil_link": "Check your CIBIL score for free on official bureau portal ↗",
    "index.helper_cibil": "Don't know your score? Leave this blank — it will not affect your eligibility evaluation.",
    "index.opt_cibil_skip": "— Leave blank / Not applicable —",
    "index.opt_cibil_750": "750 and above (Excellent)",
    "index.opt_cibil_700": "700 – 749 (Good)",
    "index.opt_cibil_650": "650 – 699 (Fair / Standard evaluation)",
    "index.opt_cibil_below": "Below 650",
    "index.opt_cibil_unknown": "I don't know / Not generated yet",
  ...
  hi: {
    ...
    "index.legend_special": "विशेष पात्रता एवं क्रेडिट आकलन",
    "index.label_pwd": "क्या आप दिव्यांग (Person with Disability) हैं? *",
    "index.opt_yes": "हाँ (Yes)",
    "index.opt_no": "नहीं (No)",
    // क्रेडिट आकलन — पुनर्भुगतान इतिहास
    "index.label_repayment": "मौजूदा / पुराने ऋण व क्रेडिट कार्ड का पुनर्भुगतान इतिहास *",
    "index.helper_repayment": "होम, ऑटो या पर्सनल लोन होने से अयोग्यता नहीं होती, जब तक ईएमआई नियमित रूप से भरी जा रही हो।",
    "index.opt_repayment_select": "पुनर्भुगतान इतिहास चुनें…",
    "index.opt_no_prior": "कोई पुराना ऋण नहीं / पहली बार उधार लेने वाले",
    "index.opt_active_ontime": "सक्रिय ऋण/कार्ड, सभी ईएमआई समय पर भुगतान",
    "index.opt_minor_delays": "अतीत में मामूली देरी (1-30 दिन), अब नियमित",
    "index.opt_npa": "खाता वर्तमान में NPA / 90+ दिन बकाया / राइट-ऑफ",
    // क्रेडिट आकलन — वैकल्पिक CIBIL स्कोर
    "index.label_cibil": "अनुमानित CIBIL / क्रेडिट स्कोर",
    "index.tag_optional": "(वैकल्पिक)",
    "index.cibil_link": "आधिकारिक ब्यूरो पोर्टल पर नि:शुल्क CIBIL स्कोर जांचें ↗",
    "index.helper_cibil": "स्कोर नहीं पता? खाली छोड़ें — यह आपकी पात्रता को प्रभावित नहीं करेगा।",
    "index.opt_cibil_skip": "— खाली छोड़ें / लागू नहीं —",
    "index.opt_cibil_750": "750 और अधिक (उत्कृष्ट)",
    "index.opt_cibil_700": "700 – 749 (अच्छा)",
    "index.opt_cibil_650": "650 – 699 (सामान्य मूल्यांकन)",
    "index.opt_cibil_below": "650 से कम",
    "index.opt_cibil_unknown": "मुझे पता नहीं / अभी तक नहीं बना",
